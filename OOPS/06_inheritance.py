class Base:
    def __init__(self, type_): #constructor of Base class
        self.type = type_

    def display(self):
        print(f"Base type: {self.type}") #instance method of Base class
    
class Derived(Base):  #inheritance
    def add(self): #instance method of Derived class
